...
JGO.BOARD.medium = {
    textures: {
        black: '/javascripts/medium/black.png',
        white: '/javascripts/medium/white.png',
        shadow:'/javascripts/medium/shadow.png',
        board: '/javascripts/medium/shinkaya.jpg'
    },
...
JGO.BOARD.mediumWalnut = JGO.util.extend(JGO.util.extend({}, JGO.BOARD.medium), {
    textures: {board: '/javascripts/medium/walnut.jpg', shadow: '/javascripts/medium/shadow_dark.png'},
